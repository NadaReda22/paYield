                    ...
                    <div class="vendor-content-wrap">
                        <div class="d-flex justify-content-between align-items-end mb-30">
                            <div>
                                ...
                                <h4 class="mb-5"><a
                                        href="/vendor/details/{{$vendor->id}}">{{ $vendor->name }}</a></h4>
                            ...
                            @php
                            $products = App\Models\Product::where('user_id',$vendor->id)->get();
                            @endphp
                            <div class="mb-10">
                        ...
                        <a href="/vendor/details/{{$vendor->id}}" class="btn btn-xs">Visit Store <i
