...
@php
    $all_products = App\Models\Product::with('brands','subcategory','reviews')->get();
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <li class="mb-5">
                                                ...
                                                <li>SubCategory: <span
                                                        class="text-brand">@if(isset($product['subcategory']['category_name']))
                            ...
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="product-detail-rating">
                                    <div class="product-rate-cover text-end">
                                        ...
                                        <span class="font-small ml-5 text-muted"> ({{ $product->reviews?->count() ?? 0 }})</span>
                                ...
                                <form class="productCart">
                                    ...
                                    <div class="detail-extralink mb-30">
                                        <div class="detail-qty border radius">
                                            ...
                                            <input type="number" name="product_quantity" class="qty-val" value="1"
                                                min="1" step="1" required>
                                            <a href="#" class="qty-up"><i class="fi-rs-angle-small-up"></i></a>
                                        </div>
                                        <div class="product-extra-link2">
                                        <button type="button" class="button button-add-to-cart" onclick="addToCart(this)">
