    ...
    <div class="container mb-80 mt-50">
        <div class="row">
            <div class="col-lg-8 mb-40">
                ...
                <h6 class="text-body" id="cartProductCount">There are <span id="productCount">0</span> products in your cart</h6>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-lg-5">
                <div id="couponWrapper" style="{{ Session::has('coupon') ? 'display: none;' : '' }}">
