                ...
                <div class="row align-items-center">
                    <div class="col-xl-3">
                        ...
                        <div class="breadcrumb">
                            <a href="/blog/posts" rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a>
                            <span></span> Blog & News
                        </div>
                    </div>
                            ...
                            <article class="wow fadeIn animated hover-up mb-30 animated">
                                ...
                                <div class="entry-content-2 pl-50">
                                    <h3 class="post-title mb-20">
                                        <a href="/blog/post/details/{{$post->id}}/{{$post->post_slug}}">{{ $post->post_title }}</a>
                                    </h3>
                                    ...
                                    <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                        <div>
                                         ...
                                         <a href="/blog/post/details/{{$post->id}}/{{$post->post_slug}}" class="text-brand font-heading font-weight-bold">Read more <i class="fi-rs-arrow-right"></i></a>
                                    </div>
                                </div>
                            </article>
                        @endforeach
                        ...
                        <div class="sidebar-widget widget-category-2 mb-50">
                            ...
                            <ul>
                                @foreach ($blogcategoryies as $category)
                                    @php
                                        $posts = App\Models\BlogPost::where('blog_category_id', $category->id)->get();
                                    @endphp

                                    <li>
                                        <a href="/blog/post/category/{{$category->id}}/{{$category->blog_category_slug}}"> <img
