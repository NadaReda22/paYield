...
@include('frontend.home_pages.home_slider')

@include('frontend.home_pages.category_slider')

@include('frontend.home_pages.banner') 

@include('frontend.home_pages.new_product')
@include('frontend.home_pages.feature_product')

@include('frontend.home_pages.tv_category')
                ...
                @foreach($hot_deals as $product)
                    <article class="row align-items-center hover-up">
                        <figure class="col-md-4 mb-0">
                            <a href="/product/details/{{$product->id}}/{{$product->product_slug}}"><img src="{{asset($product->product_thumbnail)}}"
                                    alt="no product image" /></a>
                        </figure>
...
<div class="container">
    ...
    <div id="topvendors" class="section-title wow animate__animated animate__fadeIn" data-wow-delay="0">
            ...
            <div class="vendor-wrap mb-40">
                <div class="vendor-img-action-wrap">
                    <div class="vendor-img">
                        ...
                        <a href="/vendor/details/{{$data->id}}">
                            <img class="default-img" style="border-radius: 10px; width : 100px; height : 100px; "  src="{{asset($data->photo)}}"
                                alt="" />
                        </a>
                        @endif 
                    ...
                    <div class="d-flex justify-content-between align-items-end mb-30">
                        <div>
                            ...
                            <div class="product-rate-cover">
                                ...
                                @php 
                                $total_product = \App\Models\Product::where('user_id', $data->id)->count();
                                @endphp
