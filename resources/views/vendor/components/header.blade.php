        ...
        <nav class="navbar navbar-expand">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            @forelse($user->notifications as $notification)
                               <a class="dropdown-item" href="javascript:;">
                                ...
                                @empty
                                <div class="text-center py-2 text-muted">No notifications found</div>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="header-message-list">
                                ...
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        <div class="user-online">
                                            <img src="{{asset('AdminBackend/assets/images/avatars/avatar-8.png')}}" class="msg-avatar"
                                                alt="user avatar">
                                        </div>
                                        <div class="flex-grow-1">
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret"
                    href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    @if ($vendor)
                    <img src="{{asset($vendor->photo)}}" class="user-img" alt="user avatar">
                    @endif
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="/vendor/profile"><i
                                class="bx bx-user"></i><span>Profile</span></a>
                    </li>
                    <li><a class="dropdown-item" href="/vendor/password/change"><i
                                class="bx bx-cog"></i><span>Changed Password</span></a>
                    </li>
                    <li><a class="dropdown-item"href="/vendor/dashboard"><i
                    ...
                    <li><a class="dropdown-item" href="/vendor/logout"><i
