                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="/admin/admin-manage/update/{{$admin->id}}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <img id="showImage" src="{{ $admin->photo ? asset($admin->photo) : url('AdminBackend/no_image.jpg') }}" alt="Admin" width="110" style="border-radius: 10px">
                                    </div>
                                </div>
