...
@section('admin')
    <div class="page-content">
        ...
        <div class="row row-cols-1 row-cols-md-1 row-cols-lg-3 row-cols-xl-3">
            ...
            <form  action="/admin/order/by/date" method="post">
                {{@csrf_field()}}
                <div class="col">
                    <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Search By Dat</h5>
            ...
            <form action="/admin/order/by/month" method="post">
                {{@csrf_field()}}
                <div class="col">
                    <div class="card">
            ...
            <form method="post" action="/admin/order/by/year">
                {{@csrf_field()}}
                <div class="col">
                    <div class="card">
