        ...
        <div class="row row-cols-1 row-cols-md-1 row-cols-lg-2 row-cols-xl-2">
            <div class="col">
                ...
                <div class="card">
                    ...
                    <hr>
                    <div class="card-body">
                        <table class="table" style="background:#000;font-weight: 600;">
                            <tr>
                                <th>Shipping Name:</th>
                                <th>{{ $order->name }}</th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <th>
                                    @if ($order->status == 'pending')
                                        <a href="/admin/order/pending/confirm/{{$order->id}}"
                                            class="btn btn-block btn-success" id="confirm">Confirm Order</a>
                                    @elseif($order->status == 'confirm')
                                    <a href="/admin/order/confirm/processing/{{$order->id}}" class="btn btn-block btn-success" id="processing" >Processing Order</a>

                                    @elseif($order->status == 'processing')
                                    <a href="/admin/order/processing/delivered/{{$order->id}}" class="btn btn-block btn-success" id="delivered" >Delivered Order</a>
                                    @endif
                                </th>
                            </tr>
                            ...
                            <tbody>
                                ...
                                @foreach ($orderItem as $item)
                                    <tr>
                                        ...
                                        @else
                                            <td class="col-md-2">
                                             <label>{{ $item->vendor->name??'Unknown Vendor' }} </label> {{----}}  
                                            </td>
                                        @endif
