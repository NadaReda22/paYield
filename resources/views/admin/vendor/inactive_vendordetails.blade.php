...
<div class="col-lg-12">
	<div class="card">
		...
		<form method="post" action="/admin/vendor/active/approve/{{ $inactiveVendorDetails->id}}" enctype="multipart/form-data" >
			@csrf
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					<input type="text" class="form-control" value="{{  $inactiveVendorDetails->username }}"  />
				</div>
			</div>
			<div class="row mb-3">
				<div class="col-sm-3">
				...
				<div class="col-sm-9 text-secondary">
					<input type="text" name="name" class="form-control" value=" {{$inactiveVendorDetails->shop_name}}" />
				</div>
			</div>
			<div class="row mb-3">
				<div class="col-sm-3">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					<input type="text" name="vendor_join" class="form-control" value=" {{$inactiveVendorDetails->vendor_join_date}}" />
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					...
					{{$inactiveVendorDetails->vendor_info}}
				</textarea>
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
				<img id="showImage" 
     src="{{ !empty($inactiveVendorDetails->photo) ? asset($inactiveVendorDetails->photo) : url('AdminBackend/no_image.jpg') }}"  
     alt="vendor">
				</div>
			</div>
