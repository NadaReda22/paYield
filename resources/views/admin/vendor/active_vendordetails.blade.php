...
<div class="col-lg-12">
	<div class="card">
		...
		<form method="post" action="/admin/vendor/inactive/approve/{{$activeVendorDetails->id}}" enctype="multipart/form-data" >
			@csrf
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					<input type="text" name="name" class="form-control" value="{{$activeVendorDetails->shop_name}}" />
				</div>
			</div>
			<div class="row mb-3">
				<div class="col-sm-3">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					<input type="text" name="vendor_join" class="form-control" value="{{$activeVendorDetails->vendor_join_date}}" />
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					<textarea name="vendor_info" class="form-control" id="inputAddress2" placeholder="Vendor Info " rows="3">
				{{ old('vendor_info',$activeVendorDetails->vendor_info) }}
				</textarea>
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
				<img id="showImage" 
     src="{{ !empty($activeVendorDetails->photo) ? asset($activeVendorDetails->photo) : url('AdminBackend/no_image.jpg') }}"  
     alt="vendor">
				</div>
			</div>
