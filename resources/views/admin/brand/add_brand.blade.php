...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="/admin/brand/all"  class="btn btn-primary">All Brand</a>
            ...
            <div class="main-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form method="post" id="myForm" action="/admin/brand/store" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img style="display: none" id="showImage"
                                                src="{{(!empty($brand->brand_image)? asset($brand->brand_image): url('AdminBackend/no_img.jpg'))}}"
