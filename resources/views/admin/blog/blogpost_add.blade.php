                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" method="post" action="/admin/blog/post/store" enctype="multipart/form-data" >
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <textarea name="post_short_desc" class="form-control" id="inputProductDescription" rows="3"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <textarea id="mytextarea" name="post_long_desc"> </textarea>
                                        </div>
                                    </div>
