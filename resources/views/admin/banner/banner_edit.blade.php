                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" method="post" action="/admin/banner/update/{{$banner->id}}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage" src="{{ old('image',asset($banner->image)) ?: url('AdminBackend/no_image.jpg') }}" alt="Admin"
                                                style="width:150px; height: 150px; border-radius: 10px; border : 1px solid gainsboro">
                                        </div>
                                    </div>
